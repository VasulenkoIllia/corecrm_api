...
var SearchClientDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _query_decorators = [(0, swagger_1.ApiProperty)({ example: 'Іван', description: 'Пошуковий запит для імені, прізвища, телефону або email клієнта' }), (0, class_validator_1.IsString)()];
