...
var AccessControlGuard = function () {
    ...
    var AccessControlGuard = _classThis = /** @class */ (function () {
        function AccessControlGuard_1(accessControlService, reflector) {
        ...
        AccessControlGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, accessOptions, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            request = context.switchToHttp().getRequest();
                            accessOptions = (this.reflector.get(access_control_endpoint_decorator_1.ACCESS_CONTROL_METADATA, context.getHandler()) || { accessOptions: {} }).accessOptions;
                            user = request.user;
                            if (!user || !user.id) {
                            ...
                            if (!user.companyId) {
                                throw new common_1.BadRequestException('CompanyId not provided');
                            }
                            return [4 /*yield*/, this.accessControlService.checkAccess(user.id, user.companyId, accessOptions)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, true];
                    }
