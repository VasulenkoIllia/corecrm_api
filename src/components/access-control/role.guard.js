...
var RoleGuard = function () {
    ...
    var RoleGuard = _classThis = /** @class */ (function () {
        function RoleGuard_1(prisma, reflector) {
            this.prisma = prisma;
        ...
        RoleGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, requiredRole, user, dbUser;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            console.log(request);
                            requiredRole = (this.reflector.get(access_control_endpoint_decorator_1.ACCESS_CONTROL_METADATA, context.getHandler()) || { accessOptions: {} }).requiredRole;
                            user = request.user;
                            if (!user || !user.id) {
                                throw new common_1.ForbiddenException('User not provided');
                            }
                        ...
                        case 1:
                            dbUser = _b.sent();
                            if (!dbUser || ((_a = dbUser.role) === null || _a === void 0 ? void 0 : _a.name) !== requiredRole) {
                                throw new common_1.ForbiddenException("User must have ".concat(requiredRole, " role"));
                            }
