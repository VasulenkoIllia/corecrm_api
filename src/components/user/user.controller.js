...
var user_response_dto_1 = require("@common/dto/user/user.response.dto");
...
var UserController = function () {
    ...
    var UserController = _classThis = /** @class */ (function () {
        function UserController_1(userService) {
            ...
            this.logger = new common_1.Logger(UserController.name);
        }
        UserController_1.prototype.getMe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, this.userService.findById(req.user.id)];
                        case 1:
                            user = _c.sent();
                            if (!user) {
                                this.logger.warn("User with ID ".concat(req.user.id, " not found"));
    ...
    (function () {
        ...
        _getMe_decorators = [(0, secure_endpoint_decorator_1.SecureEndpoint)('me', common_1.RequestMethod.GET), (0, swagger_1.ApiOkResponse)({ type: user_response_dto_1.UserResponseDTO }), (0, catch_error_decorator_1.CatchError)('Fetching user data')];
