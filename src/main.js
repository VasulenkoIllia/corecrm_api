...
require("reflect-metadata"); // Необхідно для роботи декораторів
var core_1 = require("@nestjs/core"); // Фабрика для створення NestJS додатку
var app_module_1 = require("./app.module"); // Головний модуль додатку
var common_1 = require("@nestjs/common"); // Пайп для валідації вхідних даних
var swagger_1 = require("@nestjs/swagger"); // Модулі для генерації Swagger документації
/**
